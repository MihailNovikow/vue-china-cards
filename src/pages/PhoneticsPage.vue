<template>
  <div>
    ...
    <p class="descr-1">Pinyin Section 1</p>
    <h2 class="title-2">A with Easy Consonants</h2>
<p class="descr-2">The pinyin vowel a has a rather uniform pronunciation in Chinese, very similar to the "a" sound in the English "father". (The two exceptions to this pronunciation rule are ian and üan, both covered in later sections.)
...
While difficult to distinguish at first, this subtle difference will become more and more apparent with prolonged exposure.</p>
<h4>Linguist's Note:</h4>
<p>The following are the IPA symbols for this section's pinyin vowel sounds:</p>
<div class="rectangle-2"><p>b	[p]   p	[ph]
 
m	[m]   f	[f]   d	[t] 
t	[th]   n	[n]   l	[l]
</p></div>
<p>Listen to the sounds of this section and try repeating them by clicking on the syllables below:</p>
